...
<div class="container pad">
	...
	<div class="panel">
		...
		<div class="panel-footer text-right">
			<a hreff="#" id="<?=$p->id;?>" class="add_cart btn btn-primary btn-lg">
	...
	<div class="col-md-12">
		<h4><i class="fa fa-history"></i> Terakhir dilihat </h4>
			...
			<?php $p=$l[0];?>
				...
				<div class="panel panel-default">
				  <?php $endurl=str_replace(" ","-",strtolower($p->nama_produk));?>
					<a 
						class     ="detail_produk" 
						href      ='<?php echo base_url("store/produk/$endurl/$p->id");?>' 
						data-id 	="<?=$p->id;?>"
						...
						<div class="panel-body">
							...
							<img class="img" height="100" width="100%" src="<?=$img;?>">
							<p></p>
						</div>
					</a>
